...
public class AppMediador extends Application {
    ...
    public void setExerciseDetailFragment(ExerciseDetail exerciseDetailFragment) {
        this.exerciseDetailFragment = exerciseDetailFragment;
    }
    ...
    public ExerciseDetail getExerciseDetailFragment() {
        return this.exerciseDetailFragment;
